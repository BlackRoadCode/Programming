...
function copyVinotecaDesktopBanner(){
  ...
  let vinotecadesktopbanner = `<a href='${ urlVinoteca }' class='vtex-display--block'><img src='/arquivos/${ imgDesktopVinoteca }' class='vtex-display--block' alt='${ altVinoteca }' title='${ altVinoteca }' /></a>`;
...
function copyVinotecaMobileBanner(){
  ...
  let vinotecamobilebanner = `<a href='${ urlVinoteca }' class='vtex-display--block'><img src='/arquivos/${ imgMobileVinoteca }' class='vtex-display--block' alt='${ altVinoteca }' title='${ altVinoteca }' /></a>`;
